                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card col-md-8 text-danger mb-4 ease-in" style="border-color: red;">
                                    <div class="card-body" align="center">
                                        <b>Pemeriksaan ABCD</b></div>
                                </div>
                            </div>
                        </div>
<!--                         <form action="<?= base_url('pilihperiksa_c/filterperiksa/'); ?>" method="post" >
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">
	                                  <input type="checkbox" name="periksa1" value="A">&nbsp;&nbsp;
									  <label for="vehicle1">Pemeriksaan A</label>
	                                </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">
	                                  <input type="checkbox" name="periksa2" value="B">&nbsp;&nbsp;
									  <label for="vehicle1">Pemeriksaan B</label>
	                                </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">
	                                  <input type="checkbox" name="periska3" value="C">&nbsp;&nbsp;
									  <label for="vehicle1">Pemeriksaan C</label>
	                                </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">
	                                  <input type="checkbox" name="periksa4" value="D">&nbsp;&nbsp;
									  <label for="vehicle1">Pemeriksaan D</label>
	                                </div>
                                </div>
                            </div>
